...
Реализация библиотеки `s21_matrix.h` для работы с матрицами на языке C.
...
3. [Реализация функций](#реализация-функций)
   - [Часть 1: Реализация функций библиотеки matrix.h](#часть-1-реализация-функций-библиотеки-matrixh)

## Введение

Проект `s21_matrix` направлен на создание библиотеки для выполнения базовых и расширенных операций с матрицами. Этот проект предоставляет возможность углубленного изучения работы с матрицами и принципов структурного программирования на языке C.

## Общая информация

Матрицы играют ключевую роль в различных областях, включая компьютерную графику, физику, экономику и другие дисциплины. Библиотека `s21_matrix.h` предоставит пользователям возможность эффективно работать с матрицами, реализуя такие операции, как создание, сложение, умножение, транспонирование, вычисление определителя и обратной матрицы.

### Основные функции

- Создание и удаление матриц
- Арифметические операции с матрицами (сложение, вычитание, умножение)
- Транспонирование и нахождение обратной матрицы
- Вычисление определителя и матрицы алгебраических дополнений

## Реализация функций

### Часть 1: Реализация функций библиотеки matrix.h

Необходимо реализовать функции для работы с матрицами, соблюдая стандарты точности и производительности, с использованием принципов структурного программирования.

- **Стандарт**: C11, компилятор gcc.
- **Тестирование**: Покрытие тестами не менее 80% каждой функции.
- **Отчетность**: Генерация отчета о покрытии кода с использованием `gcov`.
